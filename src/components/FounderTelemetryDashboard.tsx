...
export const FounderTelemetryDashboard: React.FC = () => {
  ...
  const handleSimulateInbound = (channel: 'Google' | 'GitHub' | 'SourceForge' | 'AlternativeTo') => {
    recordTelemetryEvent(
      'visit',
      `Simulated organic inbound visitor arrived from ${channel} (Live stream test verification)`,
      { customSource: channel }
    );
  };
    ...
    <div className="bg-slate-900/95 border border-slate-800 rounded-2xl p-4 sm:p-7 shadow-2xl space-y-6 text-slate-100">
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          {/* Quick Simulation Pings for Krishna */}
          <div className="flex flex-wrap items-center gap-1.5 text-[11px]">
            <span className="text-slate-500 font-semibold">Test Inbound Ping:</span>
            <button
              onClick={() => handleSimulateInbound('Google')}
              className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 text-[10px] font-bold border border-slate-700 cursor-pointer"
            >
              +Google
            </button>
            <button
              onClick={() => handleSimulateInbound('GitHub')}
              className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 text-[10px] font-bold border border-slate-700 cursor-pointer"
            >
              +GitHub
            </button>
            <button
              onClick={() => handleSimulateInbound('SourceForge')}
              className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 text-[10px] font-bold border border-slate-700 cursor-pointer"
            >
              +SourceForge
            </button>
            <button
              onClick={() => handleSimulateInbound('AlternativeTo')}
              className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 text-[10px] font-bold border border-slate-700 cursor-pointer"
            >
              +AlternativeTo
            </button>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 hover:border-indigo-500/40 transition-colors">
            <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
              <span className="font-bold text-indigo-300">Google</span>
              <span className="text-[10px] font-mono bg-indigo-500/10 text-indigo-400 px-1.5 py-0.2 rounded">Search</span>
            </div>
          ...
          <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 hover:border-violet-500/40 transition-colors">
            <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
              ...
              <span className="text-[10px] font-mono bg-violet-500/10 text-violet-400 px-1.5 py-0.2 rounded">Repos</span>
            </div>
          ...
          <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 hover:border-amber-500/40 transition-colors">
            <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
              ...
              <span className="text-[10px] font-mono bg-amber-500/10 text-amber-400 px-1.5 py-0.2 rounded">Directory</span>
            </div>
          ...
          <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 hover:border-emerald-500/40 transition-colors">
            <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
              ...
              <span className="text-[10px] font-mono bg-emerald-500/10 text-emerald-400 px-1.5 py-0.2 rounded">B2B</span>
            </div>
          ...
          <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 hover:border-cyan-500/40 transition-colors">
            <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
              ...
              <span className="text-[10px] font-mono bg-cyan-500/10 text-cyan-400 px-1.5 py-0.2 rounded">AI</span>
            </div>
            ...
            <div className="text-[10px] text-slate-500 mt-1">ChatGPT / Claude</div>
          </div>

          {/* Direct & Links Card */}
          <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 hover:border-slate-600 transition-colors">
            <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
              <span className="font-bold text-slate-300">Direct / Applet</span>
              <span className="text-[10px] font-mono bg-slate-800 text-slate-400 px-1.5 py-0.2 rounded">Direct</span>
            </div>
        ...
        <div className="max-h-96 overflow-y-auto space-y-2 pr-1 rounded-xl bg-slate-950/90 border border-slate-850 p-3">
          {filteredEvents.length === 0 ? (
            <div className="py-12 text-center text-xs text-slate-500 space-y-2">
              ...
              <div>No matching telemetry events captured yet.</div>
              <div className="text-[11px] text-slate-600">Run an audit, select an industry template, or click "+Google / +GitHub" to simulate inbound activity.</div>
            </div>
          ) : (
                ...
                <div className="space-y-1.5 flex-1">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold ${
                      event.source === 'Google' ? 'bg-indigo-500/20 text-indigo-300 border border-indigo-500/30' :
